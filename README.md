...
flowchart LR
    ...
    subgraph SECURITY["Security Protection"]
        ...
        EXPOSURE["Security Exposure<br/>Management"]
    end
    ...
    M365 -->|"Email security signals"| MDO
    ...
    ENTRA -->|"Identity & activity logs"| SENTINEL
...
The architecture keeps **identity flow, device management, security telemetry, XDR, and SIEM responsibilities technically separate**, while integrating them into a unified security-operations workflow.

[View Executive Architecture →](docs/architecture/executive-architecture.md)

[View Technical Architecture →](docs/architecture/technical-architecture.md)
